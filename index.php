...
<?php include_once './parts/header.php';   ?>
    ...
    <h1 class="display-4 fw-normal">أربح مع أحمد آل جعفر</h1>
  ...
  <div class="mb-3">
    ...
    <div  class="form-text " id="form-text error"><?php echo $errors['firstNameError'] ?></div>
  </div>

  <div class="mb-3">
    <label for="lastName" class="form-label">الأسم الأخير</label>
    <input type="text" name="lastName" class="form-control" id="lastName" value="<?php echo $lastName ?>">
    <div  class="form-text"id="form-text error"><?php echo $errors['lastNameError'] ?></div>
  </div>
  
  <div class="mb-3">
    <label for="email" class="form-label">البريد الالكتروني</label>
    <input type="text" name="email" class="form-control" id="exampleInputEmail1" value="<?php echo $email ?>">
    <div  class="emailHelp" id="form-text error"><?php echo $errors['emailError'] ?></div>
  </div>
